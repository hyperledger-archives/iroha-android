...
import click.kobaken.rxirohaandroid_sample.view.WalletView;
...
import static click.kobaken.rxirohaandroid_sample.view.fragment.WalletFragment.RefreshState.SWIPE_UP;
...
public class WalletPresenter implements Presenter<WalletView> {
    ...
    private void renderFromNetwork(WalletFragment.RefreshState state) {
        ...
        Disposable disposable = Observable.zip(
                iroha.findAccount(uuid),
                iroha.findTransactionHistory(uuid, 30, 0),
    ...
    public View.OnClickListener onRefresh() {
        return view -> transactionHistory(WalletFragment.RefreshState.EMPTY_REFRESH);
    }
