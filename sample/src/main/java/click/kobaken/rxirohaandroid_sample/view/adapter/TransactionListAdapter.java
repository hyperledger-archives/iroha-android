...
package click.kobaken.rxirohaandroid_sample.view.adapter;
...
import click.kobaken.rxirohaandroid_sample.databinding.RowTransactionListBinding;
...
public class TransactionListAdapter extends BaseAdapter {
    ...
    public void setItems(List<Transaction> transactionHistory) {
        ...
        Collections.sort(sortedTransactionList, (t1, t2) -> {
